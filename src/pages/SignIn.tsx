  ...
  return (
    <div className="max-w-md mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Sign in to your KENFUSE account</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="text-center pt-4 border-t">
            <p className="text-gray-600">
              ...
              <Link to="/signup" className="text-blue-600 font-semibold hover:text-blue-800 flex items-center justify-center mt-2">
